// algorithms/atkinson.js
export function atkinson(pixels, width, height, palette) {
    for (let y = 0; y < height; y++) {
      for (let x = 0; x < width; x++) {
        ...
        adjustPixel(pixels, x + 1, y, quantError, 1 / 8, width, height);
        adjustPixel(pixels, x + 2, y, quantError, 1 / 8, width, height);
        adjustPixel(pixels, x - 1, y + 1, quantError, 1 / 8, width, height);
        adjustPixel(pixels, x, y + 1, quantError, 1 / 8, width, height);
        adjustPixel(pixels, x + 1, y + 1, quantError, 1 / 8, width, height);
        adjustPixel(pixels, x, y + 2, quantError, 1 / 8, width, height);
      }
    }
  }
